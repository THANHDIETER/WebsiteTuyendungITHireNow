                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col">
                            ...
                            <select name="job_type_id" id="job_type_id" class="form-select" required>
                                ...
                                <option value="{{ $type->id }}" @if (old('job_type_id')==$type->id) selected
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <select name="categories[]" class="form-select select2" multiple required>
                                ...
                                <option value="{{ $cat->id }}" {{ collect(old('categories'))->contains($cat->id) ?
                                    'selected' : '' }}>
                                    {{ $cat->name }}
                                </option>
                                @endforeach
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="remote_policy_id" id="remote_policy_id"
                            ...
                            <option value="{{ $policy->id }}" {{ old('remote_policy_id')==$policy->id ? 'selected' : ''
                                }}>
                                {{ $policy->name }}
                            </option>
                            @endforeach
