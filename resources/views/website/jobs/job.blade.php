...
{{-- Styles --}}
<style>
    .search-section, .job-results-section, .pagination-section {
        margin-bottom: 2rem;
    }
    .search-wrap {
    ...
    .filter-btn:hover, .filter-toggle:hover {
        transform: translateY(-2px);
        box-shadow: 0 4px 12px rgba(43, 111, 219, 0.3);
    }
    ...
    .badge-hot:hover, .badge-top:hover {
        opacity: 0.9;
    }
    ...
    @media (max-width: 576px) {
        ...
        .section-divider, .filter-divider {
            margin: 1rem 0;
            height: 1px;
        }
        .section-title {
