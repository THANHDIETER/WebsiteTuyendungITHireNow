                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item recent-job-style2-item">
                            <div class="company-info">
                                ...
                                <div class="content">
                                    <h4 class="name"><a
                                            href="https://htmldemo.net/finate/finate/company-details.html">Inspire Fitness
                                            Co.</a></h4>
                                    <p class="address">New York, USA</p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item recent-job-style2-item">
                            <div class="company-info">
                                <div class="logo">
                                    <a href="https://htmldemo.net/finate/finate/company-details.html"><img
                                            src="../client/assets/img/companies/w3.webp" width="75" height="75"
                                            alt="Image-HasTech"></a>
                                </div>
                                <div class="content">
                                    <h4 class="name"><a
                                            href="https://htmldemo.net/finate/finate/company-details.html">Cogent Data</a>
                                    </h4>
                                    <p class="address">New York, USA</p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item recent-job-style2-item">
                            <div class="company-info">
                                <div class="logo">
                                    <a href="https://htmldemo.net/finate/finate/company-details.html"><img
                                            src="../client/assets/img/companies/w6.webp" width="75" height="75"
                                            alt="Image-HasTech"></a>
                                </div>
                                <div class="content">
                                    <h4 class="name"><a
                                            href="https://htmldemo.net/finate/finate/company-details.html">Flux Water
                                            Gear</a></h4>
                                    <p class="address">New York, USA</p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="recent-job-item recent-job-style2-item">
                            <div class="company-info">
                                <div class="logo">
                                    <a href="https://htmldemo.net/finate/finate/company-details.html"><img
                                            src="../client/assets/img/companies/w9.webp" width="75" height="75"
                                            alt="Image-HasTech"></a>
                                </div>
                                <div class="content">
                                    <h4 class="name"><a
