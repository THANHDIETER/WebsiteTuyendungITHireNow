                        ...
                        <div class="row row-gutter-70">
                                ...
                                <div class="post-item">
                                    <div class="thumb">
                                        <a href="blog-details.html">
                                            <img src="../client/assets/img/blog/2.webp" alt="Hình ảnh" width="370"
                                                height="270">
                                        </a>
                                    </div>
                                    <div class="content">
                                        ...
                                        <h4 class="title">
                                            <a href="blog-details.html">
                                                Tất cả những tính năng tuyệt vời này<br>đều có mức giá hợp lý!
                                            </a>
                                        </h4>
                                        <p>
                                            Lorem Ipsum chỉ là văn bản giả dùng trong ngành in ấn và dàn trang, đã được sử
                                            dụng từ rất lâu.
                                        </p>
                                        <div class="meta">
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-6">
                                <div class="post-item">
                                    <div class="thumb">
                                        <a href="blog-details.html">
                                            <img src="../client/assets/img/blog/3.webp" alt="Hình ảnh" width="370"
                                                height="270">
                                        </a>
                                    </div>
                                    <div class="content">
                                        ...
                                        <h4 class="title">
                                            <a href="blog-details.html">
                                                Với giao diện kéo &amp; thả của WooLentor<br>để tạo nội dung…
                                            </a>
                                        </h4>
                                        <p>
                                            Lorem Ipsum chỉ là văn bản giả dùng trong ngành in ấn và dàn trang, đã được sử
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-6">
                                <div class="post-item">
                                    <div class="thumb">
                                        <a href="blog-details.html">
                                            <img src="../client/assets/img/blog/4.webp" alt="Hình ảnh" width="370"
                                                height="270">
                                        </a>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-6">
                                <div class="post-item">
                                    <div class="thumb">
                                        <a href="blog-details.html">
                                            <img src="../client/assets/img/blog/5.webp" alt="Hình ảnh" width="370"
                                                height="270">
                                        </a>
                                    </div>
                                    <div class="content">
                                        ...
                                        <h4 class="title">
                                            <a href="blog-details.html">
                                                Giúp cửa hàng của bạn nổi bật<br>giữa đám đông bằng cách chuyển đổi
                                            </a>
                                        </h4>
                                        <p>
                                            Lorem Ipsum chỉ là văn bản giả dùng trong ngành in ấn và dàn trang, đã được sử
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-6">
                                <div class="post-item">
                                    <div class="thumb">
                                        <a href="blog-details.html">
                                            <img src="../client/assets/img/blog/6.webp" alt="Hình ảnh" width="370"
                                                height="270">
                                        </a>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-6">
                                <div class="post-item">
                                    <div class="thumb">
                                        <a href="blog-details.html">
                                            <img src="../client/assets/img/blog/7.webp" alt="Hình ảnh" width="370"
                                                height="270">
                                        </a>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-6">
                                <div class="post-item">
                                    <div class="thumb">
                                        <a href="blog-details.html">
                                            <img src="../client/assets/img/blog/8.webp" alt="Hình ảnh" width="370"
                                                height="270">
                                        </a>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-6">
                                <div class="post-item">
                                    <div class="thumb">
                                        <a href="blog-details.html">
                                            <img src="../client/assets/img/blog/9.webp" alt="Hình ảnh" width="370"
                                                height="270">
                                        </a>
                                    </div>
                                    <div class="content">
                                        ...
                                        <div class="widget-blog-post d-flex mb-3">
                                            ...
                                            <div class="content">
                                                <h4><a href="blog-details.html">Đây bao gồm việc vận chuyển nguyên liệu
                                                        thô.</a></h4>
                                                <div class="meta">
                                                    <span class="post-date"><i class="icofont-ui-calendar"></i> 10 tháng
                                                        8, 2022</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="widget-blog-post d-flex mb-3">
                                            ...
                                            <div class="content">
                                                <h4><a href="blog-details.html">Tất cả những tính năng tuyệt vời này đi kèm
                                                        mức giá.</a></h4>
                                                <div class="meta">
                                                    <span class="post-date"><i class="icofont-ui-calendar"></i> 18 tháng
                                                        8, 2022</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="widget-blog-post d-flex mb-3">
                                            ...
                                            <div class="content">
                                                <h4><a href="blog-details.html">Đây bao gồm việc vận chuyển nguyên liệu
                                                        thô.</a></h4>
                                                <div class="meta">
                                                    <span class="post-date"><i class="icofont-ui-calendar"></i> 19 tháng
                                                        8, 2022</span>
                                                </div>
                                            </div>
                                        </div>
