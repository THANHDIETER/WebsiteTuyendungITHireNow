                            ...
                            <div class="widget-item nav-menu-item2">
                                ...
                                <div id="widgetId-2" class="collapse widget-collapse-body">
                                    <div class="collapse-body">
                                        <div class="widget-menu-wrap">
                                            <ul class="nav-menu">
                                                <li><a href="https://htmldemo.net/finate/finate/account-login.html">Quick
                                                        Links</a></li>
                                ...
                                <div id="widgetId-3" class="collapse widget-collapse-body">
                                    <div class="collapse-body">
                                        <div class="widget-menu-wrap">
                                            <ul class="nav-menu">
                                                <li><a
                                                        href="https://htmldemo.net/finate/finate/account-login.html">Affiliate</a>
                                                </li>
                                                <li><a href="blog.html">Blog</a></li>
                                                <li><a href="https://htmldemo.net/finate/finate/account-login.html">Help
                                                        & Support</a></li>
                            ...
                            <div class="widget-item nav-menu-item4">
                                ...
                                <div id="widgetId-4" class="collapse widget-collapse-body">
                                    <div class="collapse-body">
                                        <div class="widget-menu-wrap">
                                            <ul class="nav-menu">
                                                <li><a href="https://htmldemo.net/finate/finate/account-login.html">Star
                                                        a Trial</a></li>
                                                <li><a href="about-us.html">How It Works</a></li>
                                                <li><a
                                                        href="https://htmldemo.net/finate/finate/account-login.html">Features</a>
                                                </li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer-bottom-content">
                        <p class="copyright">© 2022 Finate. Made with <i class="icofont-heart"></i> by <a
                                target="_blank" href="https://themeforest.net/user/codecarnival">Codecarnival.</a></p>
                    </div>
                </div>
            </div>
        </div>
