                            ...
                            <div class="card profile-greeting card-hover">
                                <div class="card-body">
                                    <div class="img-overlay">
                                        ...
                                        <p>Welcome to the Edmin family! We are delighted that you have visited our
                                            dashboard.</p><a class="btn btn-primary" href="pricing.html">Go
                                            Premium</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card project-card">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <button class="view-btn btn bg-light d-block w-100 position-relative"
                                        ...
                                        <svg class="feather">
                                            <use
                                                href="https://admin.pixelstrap.net/edmin/assets/svg/feather-icons/dist/feather-sprite.svg#chevron-down">
                                            </use>
                                        </svg>
                                        ...
                                        <li class="d-flex line-primary">
                                            ...
                                            <div class="dropdown task-dropdown">
                                                <button class="btn dropdown-toggle" type="button"
                                                    ...
                                                    <svg class="feather">
                                                        <use
                                                            href="https://admin.pixelstrap.net/edmin/assets/svg/feather-icons/dist/feather-sprite.svg#more-horizontal">
                                                        </use>
                                                    </svg>
                                                </button>
                                                <div class="dropdown-menu dropdown-menu-end"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="project-cost">
                                                <h5 class="font-light">
                                                    <svg class="svg-w-20 stroke-light me-2">
                                                        <use
                                                            href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Chart">
                                                        </use>
                                                        ...
                                                        <div class="d-flex bg-light-primary flex-column">
                                                            <div class="flex-shrink-0 border-primary">
                                                                <svg class="svg-w-24 stroke-primary">
                                                                    <use
                                                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Pie">
                                                                    </use>
                                                                </svg>
                                                            </div>
                                                        ...
                                                        <div class="d-flex bg-light-secondary flex-column">
                                                            <div class="flex-shrink-0 border-secondary">
                                                                <svg class="svg-w-24 stroke-secondary">
                                                                    <use
                                                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Category">
                                                                    </use>
                                                                </svg>
                                                            </div>
                                                            <div class="flex-grow-1">
                                        ...
                                        <div class="col-sm-4 custom-width-2">
                                            <h5 class="font-light">
                                                <svg class="svg-w-20 stroke-light me-2">
                                                    <use
                                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#User">
                                                    </use>
                                                </svg>Our crew
                                            </h5>
                                                ...
                                                <div class="customers d-inline-block avatar-group">
                                                    <ul>
                                                        <li class="d-inline-block"><img class="img-40 b-r-8"
                                                                src="../assets/images/user/13.jpg" alt="#">
                                                        </li>
                                                        <li class="d-inline-block"><img class="img-40 b-r-8"
                                        ...
                                        <div class="tab-pane fade" id="wed" role="tabpanel"
                                            ...
                                            <ul class="activity-update">
                                                ...
                                                <li class="d-flex align-items-center b-l-dark">
                                                    ...
                                                    <div class="flex-shrink-0"> <img class="img-40 b-r-10"
                                                            src="../assets/images/avatar/6.jpg" alt="">
                                                    </div>
                                                </li>
                                                <li class="d-flex align-items-center b-l-warning">
                                                    ...
                                                    <div class="flex-shrink-0"> <img class="img-40 b-r-10"
                                                            src="../assets/images/avatar/9.jpg" alt="">
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="d-flex justify-content-xl-between justify-content-evenly">
                                                <li>
                                                    <div class="badge bg-light-primary b-r-0">
                                                        <svg class="svg-menu me-1">
                                                            <use
                                                                href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#mobile">
                                                            </use>
                                                        </svg>Mobile
                                                    </div>
                                                ...
                                                <li>
                                                    <div class="badge bg-light-secondary b-r-0">
                                                        <svg class="svg-menu me-1">
                                                            <use
                                                                href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#desktop">
                                                            </use>
                                                        </svg>Desktop
                                                    </div>
                                                    <div class="d-block text-center mt-2">
                                ...
                                <div class="card-body p-0">
                                    <div class="d-flex bg-light gap-3">
                                        <div class="flex-shrink-0"> <img class="img-40 b-r-15"
                                                src="../assets/images/avatar/10.jpg" alt="Use1"></div>
                                        <div class="flex-grow-1"><a href="user-profile.html">
                                    ...
                                    <div class="d-flex gap-3">
                                        <div class="flex-shrink-0"> <img class="img-40 b-r-15"
                                                src="../assets/images/avatar/4.jpg" alt="Use2"></div>
                                        <div class="flex-grow-1"><a href="user-profile.html">
                                    ...
                                    <div class="d-flex gap-3">
                                        <div class="flex-shrink-0"> <img class="img-40 b-r-15"
                                                src="../assets/images/avatar/12.jpg" alt="Use3"></div>
                                        <div class="flex-grow-1"><a href="user-profile.html">
...
<!-- Mirrored from admin.pixelstrap.net/edmin/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2024 16:34:55 GMT -->
