        ...
        <ul class="header-right">
            <li class="modes d-flex"><a class="dark-mode">
                    ...
                    <svg class="svg-color" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path d="M21 12.79A9 9 0 1111.21 3a7 7 0 009.79 9.79z" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </a></li>
                ...
                <div class="custom-menu bookmark-dropdown py-0 overflow-hidden">
                    ...
                    <ul>
                        ...
                        <li class="d-flex align-items-center bg-light-primary">
                            <div class="flex-shrink-0 me-2"><a href="">
                                    ...
                                    <svg class="svg-color stroke-primary" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        <path d="M3 12l9-9 9 9v9a3 3 0 01-3 3H6a3 3 0 01-3-3v-9z" stroke="currentColor"
                            ...
                            <div class="d-flex justify-content-between align-items-center w-100"><a href="">Dashboard</a>
                                <svg class="svg-color icon-star" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <polygon points="12 2 15 9 22 9 17 14 19 21 12 17 5 21 7 14 2 9 9 9" stroke="currentColor"
                                        stroke-width="2" stroke-linejoin="round" fill="none" />
                                </svg>
                        ...
                        <li class="d-flex align-items-center bg-light-secondary">
                            <div class="flex-shrink-0 me-2"><a href="">
                                    <!-- Icon Pie -->
                                    <svg class="svg-color stroke-secondary" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="d-flex align-items-center bg-light-tertiary">
                            <div class="flex-shrink-0 me-2"><a href="">
                                    <!-- Icon Chart -->
                                    <svg class="svg-color stroke-tertiary" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M3 3v18h18" stroke="currentColor" stroke-width="2" stroke-linejoin="round" />
                            ...
                            <div class="touchpin-details"><a href="">
                                ...
                                <div class="touchspin-wrapper">
                                    <button class="decrement-touchspin btn-touchspin">
                                        <!-- Icon Minus -->
                                        <svg class="svg-color" width="16" height="16" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="d-flex">
                            ...
                            <svg class="svg-color" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path d="M15 3h4a2 2 0 012 2v14a2 2 0 01-2 2h-4" stroke="currentColor" stroke-width="2"
                                    stroke-linejoin="round" />
                                <path d="M10 17l5-5-5-5" stroke="currentColor" stroke-width="2" stroke-linejoin="round"
                                    stroke-linecap="round" />
