                    ...
                    <ul class="sidebar-menu" id="simple-bar">
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Info-circle">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Bookmark">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Contacts">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Tick-square">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Calendar">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#More-box">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Ticket-star">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Activity">
                                    </use>
                                </svg><span>Icons</span>
                                <svg class="feather">
                                    <use
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Icon-plus">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Edit-line">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Paper-plus">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                href="https://admin.pixelstrap.net/edmin/starter-kit/index.html" target="_blank">
                                <svg class="stroke-icon">
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Password">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Gallery">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Filter-2">
                                    </use>
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Discovery">
                                    </use>
                                </svg><span>Maps</span>
                                <svg class="feather">
                                    <use
                        ...
                        <li class="sidebar-list">
                            <svg class="pinned-icon">
                                ...
                                <svg class="stroke-icon">
                                    <use
                                        href="https://admin.pixelstrap.net/edmin/assets/svg/iconly-sprite.svg#Setting">
                                    </use>
