                        ...
                        <form action="{{ route('admin.notifications.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="type" name="type"
                                    placeholder="Ví dụ: new_job" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="message" id="message" rows="4" placeholder="Nhập nội dung thông báo..."
                                    required></textarea>
                            </div>
