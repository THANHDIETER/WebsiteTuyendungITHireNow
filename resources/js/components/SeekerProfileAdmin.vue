        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <ul v-if="selected" class="list-group list-group-flush">
              <li class="list-group-item"> <strong>Ứng viên:</strong> {{ selected.user?.name || 'N/A' }} (ID: {{
                selected.user_id }}) </li>
              ...
              <li class="list-group-item"><strong>LinkedIn: </strong>
                <a :href="selected.linkedin_url" target="_blank" v-if="selected.linkedin_url">{{ selected.linkedin_url
                  }}</a>
                <span v-else>Chưa có</span>
              </li>
              <li class="list-group-item"><strong>GitHub: </strong>
                <a :href="selected.github_url" target="_blank" v-if="selected.github_url">{{ selected.github_url }}</a>
                <span v-else>Chưa có</span>
              </li>
              ...
              <li class="list-group-item"><strong>Kinh nghiệm làm việc:</strong> {{ selected.work_experience }}</li>
              <li class="list-group-item"><strong>Kỹ năng ngoại ngữ:</strong> {{ selected.language_skills }}</li>
